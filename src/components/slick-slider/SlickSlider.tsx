...
import AppNavigationLink from "src/components/AppNavigationLink";
...
const StyledSlider = styled(Slider)(
  ({ theme, padding }: { theme: Theme; padding: number }) => ({
    ...
    [theme.breakpoints.up("sm")]: {
      ...
      "& .slick-list > .slick-track > .slick-current > div > .EntBox-root > .EntPaper-root:hover":
        {
        ...
        <>
          ...
          >
            <AppNavigationLink
              variant="h5"
              to={`/genre/${
                "apiString" in genre && genre.apiString
                  ? genre.apiString
                  : genre.id
              }`}
              sx={{
